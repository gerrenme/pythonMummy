...
bot_instruction: str = "Женя пишет"

task_lib: dict[str, list[str]] = {"PIT1": ["Что такое docstring?", "easy"],
                                  "PIT2": ["Что такое lambda-функция?", "easy"],
                                  "PIT3": ["В чем различия между итератором и генератором?", "medium"],
                                  "PIT4": ["Что такое *args и **kwargs в определении функции?", "medium"],
                                  "PIT5": ["Python полностью поддерживает ООП?", "hard"],
                                  "PIT6": ["Недоступно", "easy"],
                                  "PIT7": ["Недоступно", "easy"],
                                  "PIT8": ["Недоступно", "easy"],
                                  "PIT9": ["Недоступно", "easy"],
                                  "PIT10": ["Недоступно", "easy"],
                                  "PIT11": ["Недоступно", "easy"],
                                  "PIT12": ["Недоступно", "easy"],
                                  "PIT13": ["Недоступно", "easy"],
                                  "PIT14": ["Недоступно", "easy"],
                                  "PIT15": ["Недоступно", "easy"],
                                  "PIT16": ["Недоступно", "easy"],
                                  "PIT17": ["Недоступно", "easy"],
                                  "PIT18": ["Недоступно", "easy"],
                                  "PIT19": ["Недоступно", "easy"],
                                  "PIT20": ["Недоступно", "easy"],
                                  "PIT21": ["Недоступно", "easy"],
                                  "PIT22": ["Недоступно", "easy"],
                                  "PIT23": ["Недоступно", "easy"]}
